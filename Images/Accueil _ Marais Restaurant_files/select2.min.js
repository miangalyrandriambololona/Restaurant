    ...
    MultiSelect2 = clazz(AbstractSelect2, {
        ...
        createContainer: function () {
            var container = $(document.createElement("div")).attr({
                ...
                "    <label for='' class='select2-offscreen'></label>",
                "    <input type='text' autocomplete='off' style='border:none; height:auto !important;' autocorrect='off' autocapitalize='off' spellcheck='false' class='select2-input'>",
                "  </li>",
                "</ul>",
        ...
        addSelectedChoice: function (data) {
            var enableChoice = !data.locked,
                enabledItem = $(
                    "<li id='" + this.id(data) +"' class='select2-search-choice'>" +
                    "    <div></div>" +
        ...
        processDuplicatedResults: function () {
            ...
            if(itemIDs != ""){
                ...
                if(hf == undefined) {
                    ...
                    input.setAttribute("class", "selected_choice");
